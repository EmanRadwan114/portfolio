...
const About: React.FC = () => {
  ...
  return (
    <section className="grid grid-cols-1 xl:grid-cols-2 gap-x-4 gap-y-10 md:px-30 min-h-screen pt-16 lg:pt-24">
      {/* info */}
      <div>
        {/* title */}
        ...
        <p className="mt-2 text-muted-foreground text-lg md:text-xl/relaxed">
          Frontend Developer with expertise in the MERN stack. I actively engage
          on LinkedIn and love learning new skills. I enjoy creating modern,
      ...
      {/* img */}
      <div className="sm:w-[85%] lg:w-[70%] mx-auto xl:w-fit">
        <CodeSnippet />
      </div>
    </section>
  );
